...
// ChunkFile is a function main purpose is to turn file into small chunks and
//
//	add metadata for each chunk
func (c *DefaultFileChunker) ChunkFile(filePath string) ([]ChunkMeta, error) {
	var chunks []ChunkMeta

	// open file for read process
	...
	// creating buffer to hold chunk data based on chunk size
